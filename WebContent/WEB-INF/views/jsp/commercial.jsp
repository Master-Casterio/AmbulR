...
<link rel="stylesheet" href="css_commercial.css">
...
<body>
	...
	<ul id="menu-bar">
		...
		<li><a href="pageurgenceindex.html">Urgences</a>
		<li class="logo"><img src="image.png" width="50px" height="50px"
			align="right"></li>
	...
	<div class="cadre">
		<ol class="flex-container">
			...
			Ipsum.
			<img class="image" src="http://www.keruve.com/css/keruve-2015.jpg">
